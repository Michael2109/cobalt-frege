/*
  ...
  C:/Users/Michael/Desktop/frege/src/main/frege/HelloFrege.fr Do not edit this file!
...
@frege.runtime.Meta.FregePackage(
  source="C:\\Users\\Michael\\Desktop\\frege\\src\\main\\frege\\HelloFrege.fr",
  time=1528648496117L, ops={},
  imps={
  ...
  symvs={
    @frege.runtime.Meta.SymV(
      offset=90, name=@frege.runtime.Meta.QName(pack="HelloFrege", base="testLength"), stri="s",
      sig=0, depth=0, rkind=49
    ),
    @frege.runtime.Meta.SymV(
      offset=135, name=@frege.runtime.Meta.QName(pack="HelloFrege", base="main"), stri="s(u)",
      sig=2, depth=1, rkind=49
    ),
    @frege.runtime.Meta.SymV(
      offset=27, name=@frege.runtime.Meta.QName(pack="HelloFrege", base="greeting"), stri="s",
...
final public static java.lang.String greeting = "Hello this is a test";
